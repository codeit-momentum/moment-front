...
import CreateMoment from '../pages/Moment/CreateMoment/CreateMoment';
import MomentComplete from '../pages/Moment/Complete/MomentComplete';
import MyPage from '../pages/MyPage/MyPage';
import BucketList from '../pages/Moment/BucketList/BucketList';
import Upload from '../pages/Moment/Upload/Upload';
import SelectMode from '../pages/Moment/SelectMode/SelectMode';
