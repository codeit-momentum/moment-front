...
import CreateMoment from '../pages/Moment/Create/CreateMoment/CreateMoment';
import MomentComplete from '../pages/Moment/Create/Complete/MomentComplete';
import MyPage from '../pages/MyPage/MyPage';
import BucketList from '../pages/Moment/BucketList/BucketList';
import Upload from '../pages/Moment/Upload/Upload';
import SelectMode from '../pages/Moment/Create/Mode/SelectMode';
